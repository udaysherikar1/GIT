...
proc ::GA_Report::GUI_Launch {} {
	...
	pack $ui(mainFrame) -fill both -expand true -side top

	set ui(subFrame3) [frame $ui(mainFrame).b ]
	pack $ui(subFrame3) -fill both -expand true -pady 5

	set ui(subFrame2) [frame $ui(mainFrame).c ]
	pack $ui(subFrame2) -fill both -expand true -pady 5

	set ui(optionframe) [frame $ui(mainFrame).d ]
	pack $ui(optionframe) -fill both -expand true -pady 5

	set ui(optionframe1) [frame $ui(mainFrame).e ]
	pack $ui(optionframe1) -fill both -expand true -pady 5

	set ui(optionframe11) [frame $ui(mainFrame).f ]
	pack $ui(optionframe11) -fill both -expand true -pady 5

	set ui(optionframe21) [frame $ui(mainFrame).g ]
	pack $ui(optionframe21) -fill both -expand true -pady 5


	set ui(optionframe22) [frame $ui(mainFrame).g1 ]
	pack $ui(optionframe22) -fill both -expand true -pady 5
	
	

	set ui(subFrame10) [frame $ui(mainFrame).h ]
	pack $ui(subFrame10) -fill both -expand true -pady 5


	set ui(optionframe2) [frame $ui(mainFrame).i ]
	pack $ui(optionframe2) -fill both -expand true -pady 5



	set ui(optionframe3) [frame $ui(mainFrame).j ]
	pack $ui(optionframe3) -fill both -expand true -pady 5


	set ui(subFrame11) [frame $ui(mainFrame).k ]
	pack $ui(subFrame11) -fill both -expand true -pady 5

	set ui(optionframe4) [frame $ui(mainFrame).m ]
	pack $ui(optionframe4) -fill both -expand true -pady 5

	set ui(optionframe41) [frame $ui(mainFrame).n ]
	pack $ui(optionframe41) -fill both -expand true -pady 5

	set ui(optionframe5) [frame $ui(mainFrame).p ]
	pack $ui(optionframe5) -fill both -expand true -pady 5
	
	set ui(optionframe6) [frame $ui(mainFrame).r ]
	pack $ui(optionframe6) -fill both -expand true -pady 5
	
	set ui(optionframe7) [frame $ui(mainFrame).s ]
	pack $ui(optionframe7) -fill both -expand true -pady 5

	set ui(subFrame1) [frame $ui(mainFrame).q ]
	pack $ui(subFrame1) -fill both -expand true -pady 5
	...
	pack $ui(labelFrame001)  -fill both   -expand true
	...
	set ui(labelFrame0031) [hwtk::combobox $ui(subFrame3).labelFrame0031 -textvariable ::GA_Report::c3var -width 15 -state readonly -values $solver_names] 
	set ui(labelFrame004) [hwtk::label $ui(subFrame3).labelFrame004 -text " Client "  ]
	set ui(labelFrame0041) [hwtk::combobox $ui(subFrame3).labelFrame0041 -textvariable ::GA_Report::c4var -width 12 -state readonly -values $client_names ] 
	set ui(labelFrame005) [hwtk::label $ui(subFrame3).labelFrame005 -text " Product "  ]
	set ui(labelFrame0051) [hwtk::combobox $ui(subFrame3).labelFrame0051 -textvariable ::GA_Report::c5var -width 12 -state readonly -values $product_names] 
	...
	pack $ui(labelFrame003) $ui(labelFrame0031) -side left  -expand true  -pady 1 
	pack $ui(labelFrame004) $ui(labelFrame0041) -side left  -expand true  -pady 1 
	pack $ui(labelFrame005) $ui(labelFrame0051) -side left -expand true  -pady 1
	pack $ui(labelFrame006) $ui(labelFrame0061) -side left -expand true  -pady 1 
	...
	pack $ui(labelFrame006) -fill both   -expand true -side top 
	pack $ui(checkButton1) -side left -fill x -expand true -padx 1 -pady 1
	################################################################################################################
	...
	pack $ui(checkButton2) -side left -fill x -expand true -padx 1 -pady 1
	################################################################################################################
	...
	pack $ui(checkButton3) -side left -fill x -expand true -padx 1 -pady 1
	...
	pack $ui(checkButton4) -side left -fill x -expand true -padx 1 -pady 1
	...
	pack $ui(checkButton5) -side left -fill x -expand true -padx 1 -pady 1
	...
	pack $ui(checkButton6) -side left -fill x -expand true -padx 1 -pady 1
	...
	pack $ui(checkButton7) -side left -anchor sw -fill x -expand true -padx 1 -pady 1

	set ui(checkButton8)  [eval list [hwtk::checkbutton $ui(optionframe1).ck8 -text "Retainer Force   " -help "Page with Retainer force labels and curves." -variable ::GA_Report::cbState(empty8)]];
	pack $ui(checkButton8) -side left -fill x -expand true -padx 1 -pady 1

	set ui(checkButton9)  [eval list [hwtk::checkbutton $ui(optionframe1).ck9 -text "Screw Forces     " -help "Page with Screw force labels and curves." -variable ::GA_Report::cbState(empty9)]];
	pack $ui(checkButton9) -side left -fill x -expand true -padx 1 -pady 1

	set ui(checkButton10)  [eval list [hwtk::checkbutton $ui(optionframe1).ck10 -text "Heat Stake forces" -help "Page with Heat Stake force labels and curves." -variable ::GA_Report::cbState(empty10)]];
	pack $ui(checkButton10) -side left -fill x -expand true -padx 1 -pady 1
	...
	set ui(checkButton12)  [eval list [hwtk::checkbutton $ui(optionframe11).ck12 -text "Reserved    " -help "Reserved for additional plots." -variable ::GA_Report::cbState(empty12)]];
	pack $ui(checkButton12) -side left -fill x -expand true -padx 1 -pady 1
	...
	pack $ui(checkButton13) -side left -fill x -expand true -padx 1 -pady 1
	...
	pack $ui(checkButton14) -side left -fill x -expand true -padx 1 -pady 1
	...
	pack $ui(checkButton15) -side left -fill x -expand true -padx 1 -pady 1

	set ui(checkButton16)  [eval list [hwtk::checkbutton $ui(optionframe11).ck16 -text "Reserved" -help "Reserved for additional plots." -variable ::GA_Report::cbState(empty16)]];
	pack $ui(checkButton16) -side left -fill x -expand true -padx 1 -pady 1
	...
	pack $ui(checkButton17) -side left -fill x -expand true -padx 1 -pady 1
	...
	pack $ui(checkButton18) -side left -fill x -expand true -padx 1 -pady 1

	set ui(checkButton19)  [eval list [hwtk::checkbutton $ui(optionframe21).ck19 -text "WR-Master" -help "Window regulator- Animation and displacement plot." -variable ::GA_Report::cbState(empty19)]];
	pack $ui(checkButton19) -side left -fill x -expand true -padx 1 -pady 1

	set ui(checkButton20)  [eval list [hwtk::checkbutton $ui(optionframe21).ck20 -text "WR-BIW" -help "BIW animation and stress plots for Window Regulators." -variable ::GA_Report::cbState(empty20)]];
	pack $ui(checkButton20) -side left -fill x -expand true -padx 1 -pady 1

	set ui(checkButton21)  [eval list [hwtk::checkbutton $ui(optionframe21).ck21 -text "WR-Parts" -help "Parts Stress and ISO." -variable ::GA_Report::cbState(empty21)]];
	pack $ui(checkButton21) -side left -fill x -expand true -padx 1 -pady 1
	...
	pack $ui(checkButton22) -side left -fill x -expand true -padx 1 -pady 1
	...
	pack $ui(checkButton23) -side left -fill x -expand true -padx 1 -pady 1
	...
	pack $ui(checkButton24) -side left -fill x -expand true -padx 1 -pady 1
	...
	set ui(labelFrame00101) [entry $ui(optionframe3).labelFrame00101 -text "" -textvariable ::GA_Report::retainer_strings -width 100 ]
	set ui(labelFrame00111) [entry $ui(optionframe3).labelFrame00111 -text "" -textvariable ::GA_Report::ht_strings -width 100]
	set ui(labelFrame00121) [entry $ui(optionframe3).labelFrame00121 -text "" -textvariable ::GA_Report::screw_strings -width 100]

	pack $ui(labelFrame010) 
	pack $ui(labelFrame00101)
	pack $ui(labelFrame011) 
	pack $ui(labelFrame00111) 
	pack $ui(labelFrame012) 
	pack $ui(labelFrame00121) 
	...
	pack $ui(labelFrame021) $ui(labelFrame00211) $ui(labelFrame0211) $ui(labelFrame002111) $ui(labelFrame0212) $ui(labelFrame002112) -side left 
	...
	set ui(labelFrame0410) [hwtk::label $ui(optionframe5).labelFrame0410 -text "  Master Report Folder "  ]
	...
	set ui(labelFrame03100) [hwtk::label $ui(optionframe6).labelFrame03100 -text "  Admin"  ]
	set ui(labelFrame03200) [entry $ui(optionframe6).labelFrame03200 -text "" -textvariable ::GA_Report::admin_pass -width 30]
	set ui(labelFrame03201) [entry $ui(optionframe6).labelFrame03201 -text "" -textvariable ::GA_Report::decrypt_path -width 30]
	
	pack [button $ui(labelFrame03100).rbe14 -text "convert"  -font {Helvetica 8 bold} -command {::GA_Report::convert_files  }] -side left -expand true 
	pack [button $ui(labelFrame03100).rbe15 -text "calculate"  -font {Helvetica 8 bold} -command {::GA_Report::calculate_files  }] -side left -expand true
	...
	pack [button $ui(labelFrame001011).rbe10 -text "Publish Report"  -font {Helvetica 8 bold} -command {::GA_Report::Generate_python_head  }] -side left -expand true 
	...
	pack [button $ui(labelFrame001011).rbe13 -text "Help"  -font {Helvetica 8 bold} -command {::GA_Report::Help_open  }] -side left -expand true 
...
proc ::GA_Report::File_load {args} {
	...
	#hwt::PopupWorkingWindow "loading the results..."
	.mytoplevel.a.c.labelFrame002.rbe61 configure -background green
	if {[llength $pArr(entityList)]} {
...
proc ::GA_Report::sessionload { report_pagetype_list_passed sol_choice cl_choice prod_choice  } {

    set ::GA_Report::partwise_stress [list]
	puts " values printed from function"
	puts $report_pagetype_list_passed
	puts $sol_choice
	puts $cl_choice
	puts $prod_choice
...
proc ::GA_Report::load_page_extract { } {
	...
	for {set i 1} {$i <= [master_project GetNumberOfPages]} {incr i} {
		...
		for {set j 1} {$j <= [pgh$t GetNumberOfWindows]} {incr j} {
			...
			foreach list_val $stress_sort_list { 	puts $fp_sorted $list_val 		}
			close $fp_sorted;
...
proc remove_stuff_01 { } {
		...
		for {set i 1} {$i < [ master_project GetNumberOfPages]} {incr i} {
			...
			#for {set j 1} {$j <= [pgh$t GetNumberOfWindows]} {incr j} {
			#hwi OpenStack;
			pgh$t GetWindowHandle wh$t 1
			wh$t GetClientHandle posth$t
			posth$t GetModelHandle mh$t [posth$t GetActiveModel]
			mh$t GetResultCtrlHandle resh$t
			resh$t GetContourCtrlHandle ch$t

			ch$t SetDataType "$::GA_Report::strain_datatype"
			ch$t SetDataComponent $::GA_Report::strain_datacomp
			ch$t SetLayer Max
			ch$t SetAverageMode advanced
		...
		for {set i 1} {$i <= [master_project GetNumberOfPages]} {incr i} {
			...
			for {set j 1} {$j <= [pgh$t GetNumberOfWindows]} {incr j} {
				...
				set query_output_name [ lindex $output_file_list $filename_count]
				#set fileName [file join "$dirName" "querypg${i}win${j}.csv"]
				set fileName [file join "$dirName" "$strain_head$query_output_name$formatcsv"]
				set fp [open "$fileName" w]
				#puts $fp "Loadcase Simulation CompID CompName MaxElemID MaxValue"
				puts $fp "LOAD_CASE, INCREMENT, COMPONENT_ID, COMPONENT_NAME, MAXIMUM_ID, MAXIMUM_VALUE"
				...
				foreach subcase $subcase_num {
					...
					for {set k 0} {$k < $simu_num} {incr k} {
						...
						for { ih$t First }  { [ih$t Valid] } { ih$t Next } {
							...
							# find max of data comp name from iterations
							# check with parts - the data comp name -add the local group max.
							#print only the local group max and ids in another csv file.
							#organize all of this in a function.
...
proc remove_stuff { } {
		...
		#hwi GetSessionHandle sh3
		set dirName $::GA_Report::dir_for_parts_list$slash_char$::GA_Report::data_folder
		#set dirName $::GA_Report::dir_for_parts_list 
		#set dirName [master_session GetSystemVariable "CURRENTWORKINGDIR"]
		#sh3 GetProjectHandle ph3
		set filename_count 0
		for {set i 1} {$i < [master_project GetNumberOfPages]} {incr i} {
			#hwi OpenStack
			master_project GetPageHandle pgh$t $i
			...
			ch$t SetDataType "$::GA_Report::plot_disp_datatype"
		...
		for {set i 1} {$i <= [ master_project GetNumberOfPages]} {incr i} {
			...
			for {set j 1} {$j <= [pgh$t GetNumberOfWindows]} {incr j} {
				...
				set query_output_name [ lindex $output_file_list $filename_count]
				#set fileName [file join "$dirName" "querypg${i}win${j}.csv"]
				set fileName [file join "$dirName" "$disp_head$query_output_name$formatcsv"]
				set fp [open "$fileName" w]
				#puts $fp "Loadcase Simulation CompID CompName MaxElemID MaxValue"
				puts $fp "LOAD_CASE, INCREMENT, COMPONENT_ID, COMPONENT_NAME, MAXIMUM_ID, MAXIMUM_VALUE"
       ...
       hwt::PopdownWorkingWindow
		...
		#defining this can generate the top right report image , door and trim back view, for cockpit another. trunck trims also another.
		...
		#$sol_choice $cl_choice $prod_choice
...
proc ::GA_Report::partwise_stress { op_file_name op_file_path page_num_current  } {
				...
				set op_file_cur [ string map {".erfh5" ""} $op_file ]
					...
					#added this to make plot fixed from dynamic
					...
					if {![string match $menuName $default_pref_file]} {
						...
						while {$newPrefFileIndex < $n_pref_files} {
							...
							if {[string match $menuName $pref_file_menu]} {
								...
								if {$debug} {puts "Loaded \"$newPrefFileIndex\" \"$pref_file_menu\" \"$pref_file_path\""}
								break;
							}
...
proc ::GA_Report::stress_name_process { read_parts_path file1 } {
						...
						#puts " part name after csv removal $part_mat "
					...
					foreach file_selected $::GA_Report::selected_files_list {
						...
						foreach page_selected $::GA_Report::pages_selected {
							...
							if {$page_selected == "fdenergy" } {  
								...
								#puts " after fdenergy page is $page_number"
							...
							if {$page_selected == "partwisestress" } { 
								...
								set page_number $page_from_fun
								#puts " after stress plot page is $page_number"
							...
							for {set i $page_number } {$i < $page_from_fun} {incr i} {
								...
								set page_number $page_from_fun
								#puts " after strain plot page is $page_number"
							...
							if {$page_selected == "sunexposure_assembly" } { 
								...
								set page_number $page_from_fun
								#puts " after sunexposure_assembly page is $page_number"
							...
							if {$page_selected == "sunexposure_parts" } { 
								...
								set page_number $page_from_fun
								#puts " after sunexposure_parts page is $page_number"
...
proc ::GA_Report::image_generate {} {
					...
					for {set i $::GA_Report::page_starter_num } {$i < $::GA_Report::final_page_number} {incr i} {
						...
						if { $page_type == "partwise_stress_page" } {   ::GA_Report::image_partwise_stress_master $file_name  $page_type  $Page_number                  }
						
							if { $::GA_Report::cbState(empty24) == 1} {
						
							if { $page_type == "partwise_strain_page" } {   ::GA_Report::image_partwise_strain_master_vonmises $file_name  $page_type  $Page_number         }
						
							} else {
						
							if { $page_type == "partwise_strain_page" } {   ::GA_Report::image_partwise_strain_master $file_name  $page_type  $Page_number         }
